        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <div className="mt-6">
            {cartItems.length > 0 ? (
              <Link
                to="/checkout"
                className="flex items-center justify-center rounded-md border border-transparent bg-book-violet-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
              >
